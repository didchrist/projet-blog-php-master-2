...
if (isset($title) and isset($description) and isset($option) and isset($image_chemin) and !isset(($_POST['article-index']))) {
    $data = [...$data, [
        'title' => $title,
        'image' => $image_chemin,
...
if (isset($_POST['validate']) and isset($_POST['article-index'])) {
