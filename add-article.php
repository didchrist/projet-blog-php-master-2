                ...
                <form action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-control">
                        ...
                        <select name="category" id="">
                            ...
                            <option value="nature" <?= $option1 ?? '' === 'nature' ? 'selected':''; ?>>Nature</option>
                            <option value="technology" <?= $option2 ?? '' === 'technology' ? 'selected':''; ?>>Technology</option>
                            <option value="politics" <?= $option3 ?? '' === 'politics' ? 'selected':''; ?>>Politics</option>
                        </select> 
                    </div>
